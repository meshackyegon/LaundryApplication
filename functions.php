...
function payment(){ 
	global $db, $paymode, $paydate, $paytime, $payname, $payid;
	//   $path="img/";
    //   $qrcode= $path.time().".png";
    //   $qrimage=time().".png";
      $paymode=e($_POST['paymode']);
      $payid=e($_POST['payid']);
      $payname=e($_POST['payname']);
      $paydate=e($_POST['paydate']);
      $paytime=e($_POST['paytime']);
      $sql= "INSERT INTO payment (paymode, payid, payname, paydate, paytime) VALUES ('$paymode','$payid','$payname', '$paydate', '$paytime')";
	  $result=mysqli_query($db,$sql);
        if($result){
			echo"Payment record captured successfully";
		}else{
			echo"Payment record not captured";
		}
